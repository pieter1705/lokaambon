...
<head>
    ...
    <title>Tugas & Fungsi - LOKA MONITOR SFR AMBON</title>
</head>
<body>
    <header class="header">
    ...
    <main class="hero-section py-20 px-6 bg-gray-50">
    <div class="container mx-auto max-w-6xl">
        <div class="text-center mb-16">
            <h2 class="text-xl md:text-2xl font-bold text-[#002B49] tracking-[0.2em] uppercase mb-4 reveal-left">
                TUGAS POKOK DAN FUNGSI
            </h2>
            <div class="h-1 w-24 bg-blue-500 mx-auto mb-4"></div>
            <h2 class="text-gray-700 font-medium">LOKA MONITOR SPEKTRUM FREKUENSI RADIO AMBON</h2>
        </div>
        
        <div class="mb-20">
            <div class="flex items-center gap-4 mb-8 reveal-left">
                <i class="ri-briefcase-fill text-3xl text-blue-600"></i>
                <h3 class="text-2xl md:text-3xl font-bold text-gray-800">TUGAS POKOK</h3>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-gray-700 leading-relaxed">Melaksanakan pengawasan/pengendalian yang meliputi kegiatan pengamatan/observasi, deteksi sumber pancaran, monitoring dan Penertiban, Pengukuran koordinasi Monitor Frekuensi Radio dll.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-gray-700 leading-relaxed">Melaksanakan urusan Tata Usaha dan Rumah Tangga UPT Loka Monitor Spektrum Frekuensi Radio Ambon.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-gray-700 leading-relaxed">Membuat Laporan Mingguan, Bulanan, Tahunan kepada Ditjen Infrastruktur Digital ( DJID ) mengenai pelaksanaan program kerja.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-gray-700 leading-relaxed">Pelayanan pengaduan masyarakat terhadap gangguan Spektrum Frekuensi Radio.</p>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="flex items-center gap-4 mb-8 reveal-left">
                <i class="ri-settings-4-fill text-3xl text-blue-600"></i>
                <h3 class="text-2xl md:text-3xl font-bold text-gray-800">FUNGSI UTAMA</h3>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <i class="ri- Barrington-line text-blue-500 mb-3 block text-xl"></i>
                    <p class="text-sm text-gray-700">Penyusunan rencana dan Program, penyedian suku cadang, pemeliharaan Perangkat monitor spektrum frekuensi radio.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-sm text-gray-700">Pengamatan, deteksi lokasi sumber pancaran, pemantauan/monitor spektrum frekuensi radio.</p>
                </div>
                <!--<div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">-->
                <!--    <p class="text-sm text-gray-700">Pelaksanaan kalibirasi dan perbaikan Perangkat monitor spektrum frekuensi radio.</p>-->
                <!--</div>-->
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-sm text-gray-700">Pelaksanaan urusan Tata Usaha dan rumah Tangga UPT Monitor Spektrum Frekuensi Radio.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-sm text-gray-700">Koordinasi Monitor Spektrum Frekuensi Radio baik Nasional maupun Internasional.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-sm text-gray-700">Penertiban dan Penyelidikan pelanggaran terhadap pengguna Spektrum Frekuensi Radio.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-sm text-gray-700">Pelayanan pengaduan masyarakat terhadap gangguan Spektrum Frekuensi Radio.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-sm text-gray-700">Pelaksanaan Evaluasi dan Pengujian ilmiah serta Pengukuran Spektrum Frekuensi Radio.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-600 hover:shadow-lg transition-shadow">
                    <p class="text-sm text-gray-700">Koordinasi instansi terkait dalam Rangka penegakan hukum di bidang Spektrum Frekuensi Radio.</p>
                </div>
            </div>
        </div>
    </div>
