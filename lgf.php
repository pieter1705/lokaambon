...
<head>
    ...
    <title>Laporan Gangguan Frekuensi - LOKA MONITOR SFR AMBON</title>
</head>
<body>
    <header class="header">
    ...
    <div class="container mx-auto max-w-5xl">
        <div class="text-center mb-16">
            <h3 class="text-blue-600 font-bold uppercase tracking-widest mb-2">Pusat Bantuan</h3>
            <h2 class="text-3xl md:text-4xl font-black text-[#002B49] mb-4">Langkah-Langkah Pengaduan</h2>
            <div class="h-1.5 w-24 bg-blue-600 mx-auto rounded-full"></div>
            <p class="text-gray-500 mt-6 max-w-2xl mx-auto">
                Berikut adalah panduan lengkap tata cara registrasi dan prosedur pelaporan gangguan frekuensi radio bagi pemegang ISR.
            </p>
        </div>

        <div class="mb-20">
            <div class="flex items-center gap-4 mb-10 reveal-left">
                <span class="bg-[#002B49] text-white w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg">
                    <i class="ri-user-add-line text-2xl"></i>
                </span>
                <h3 class="text-2xl font-bold text-gray-800">1. Tata Cara Registrasi (Pemegang ISR)</h3>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
                    <div class="text-blue-600 font-black text-4xl opacity-20 mb-4 group-hover:opacity-100 transition-opacity">01</div>
                    <p class="text-gray-700 text-sm leading-relaxed">
                        Buka aplikasi <strong>Trouble Ticket</strong> melalui laman: 
                        <a href="http://laporgangguansfr.postel.go.id" target="blank" class="text-blue-600 underline">laporgangguansfr.postel.go.id</a>
                    </p>
                </div>
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
                    <div class="text-blue-600 font-black text-4xl opacity-20 mb-4 group-hover:opacity-100 transition-opacity">02</div>
                    <p class="text-gray-700 text-sm">Pilih link <strong>User Registration</strong> di bagian atas laman.</p>
                </div>
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
                    <div class="text-blue-600 font-black text-4xl opacity-20 mb-4 group-hover:opacity-100 transition-opacity">03</div>
                    <p class="text-gray-700 text-sm">Centang kotak <strong>"Ya, Saya setuju"</strong> pada laman Term & Condition, lalu klik Next.</p>
                </div>
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
                    <div class="text-blue-600 font-black text-4xl opacity-20 mb-4 group-hover:opacity-100 transition-opacity">04</div>
                    <p class="text-gray-700 text-sm">Pilih kategori <strong>"Pemegang ISR atau Non Pemegang ISR"</strong> </p>
                </div>
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
                    <div class="text-blue-600 font-black text-4xl opacity-20 mb-4 group-hover:opacity-100 transition-opacity">05</div>
                    <p class="text-gray-700 text-sm">Isi data pribadi secara lengkap dan klik <strong>Save</strong> untuk melanjutkan.</p>
                </div>
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
                    <div class="text-blue-600 font-black text-4xl opacity-20 mb-4 group-hover:opacity-100 transition-opacity">06</div>
                    <p class="text-gray-700 text-sm">Cek inbox email terdaftar, klik tombol <strong>Konfirmasi Akun</strong> untuk aktivasi.</p>
                </div>
            </div>
        </div>

        <div class="bg-[#002B49] rounded-[40px] p-8 md:p-12 shadow-2xl relative overflow-hidden">
            <div class="absolute -top-24 -right-24 w-64 h-64 bg-blue-500/10 rounded-full"></div>

            <div class="flex items-center gap-4 mb-12 relative z-10">
                <span class="bg-blue-500 text-white w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg">
                    <i class="ri-alarm-warning-line text-2xl"></i>
                </span>
                <h3 class="text-2xl font-bold text-white">2. Prosedur Pelaporan Gangguan</h3>
            </div>

            <div class="space-y-8 relative z-10">
                <div class="flex gap-6">
                    <div class="flex flex-col items-center">
                        <div class="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold border-4 border-[#002B49]">1</div>
                        <div class="w-0.5 h-full bg-blue-500/30"></div>
                    </div>
                    <div class="pb-8">
                        <h4 class="text-blue-400 font-bold mb-1">Login Akun</h4>
                        <p class="text-gray-300 text-sm">Masukkan username dan password, pilih Eksternal SDPPI, pilih Bahasa, lalu Login.</p>
                    </div>
                </div>

                <div class="flex gap-6">
                    <div class="flex flex-col items-center">
                        <div class="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold border-4 border-[#002B49]">2</div>
                        <div class="w-0.5 h-full bg-blue-500/30"></div>
                    </div>
                    <div class="pb-8">
                        <h4 class="text-blue-400 font-bold mb-1">Pusat Bantuan</h4>
                        <p class="text-gray-300 text-sm">Klik menu Aplikasi di bagian kiri, pilih Pusat Bantuan, lalu klik <strong>Tambah Kasus Gangguan</strong>.</p>
                    </div>
                </div>

                <div class="flex gap-6">
                    <div class="flex flex-col items-center">
                        <div class="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold border-4 border-[#002B49]">3</div>
                        <div class="w-0.5 h-full bg-blue-500/30"></div>
                    </div>
                    <div class="pb-8">
                        <h4 class="text-blue-400 font-bold mb-1">Isi Form</h4>
                        <p class="text-gray-300 text-sm">Lengkapi seluruh data pada form laporan gangguan, lalu tekan tombol <strong>Kirim</strong>.</p>
                    </div>
                </div>

                <div class="flex gap-6">
                    <div class="flex flex-col items-center">
                        <div class="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center text-white font-bold border-4 border-[#002B49]">
                            <i class="ri-check-line"></i>
                        </div>
                    </div>
                    <div class="pb-2">
                        <h4 class="text-green-400 font-bold mb-1">Selesai</h4>
                        <p class="text-gray-300 text-sm">Cek status pengaduan (Open). Anda akan menerima email notifikasi berisi bukti lapor dalam format dokumen.</p>
                    </div>
                </div>
            </div>
        </div>

        <div class="mt-12 bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-2xl">
            <div class="flex gap-4">
                <i class="ri-information-fill text-blue-600 text-2xl"></i>
                <div>
                    <h4 class="font-bold text-blue-900">Butuh Bantuan Lebih Lanjut?</h4>
                    <p class="text-blue-800 text-sm mt-1">Jika Anda mengalami kendala saat pengisian form, silakan hubungi layanan pengaduan kami di nomor WhatsApp yang tertera di bawah.</p>
                </div>
            </div>
        </div>
    </div>
