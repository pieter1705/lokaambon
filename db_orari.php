...
<head>
    ...
    <style>
        ...
        /* PERBAIKAN: Mengatur layout agar konten berada di tengah */
        .layout-grid {
            display: block; /* Diubah dari grid ke block agar tidak membagi kolom samping */
            max-width: 1200px; /* Dipersempit agar konten berkumpul di tengah */
            margin: 0 auto; /* Margin auto kiri-kanan untuk centering */
            padding: 0 1.5rem;
        }
...
<body class="bg-gray-50">
    ...
    <section class="mt-20 bg-[#002B49] text-white py-16 shadow-lg relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <nav class="text-sm mb-4 text-blue-300 uppercase tracking-widest font-bold">Database &nbsp;/&nbsp; ORARI</nav>
            <h1 class="text-4xl md:text-5xl font-black tracking-tight uppercase">Dashboard ORARI</h1>
    ...
    <div class="dashboard-section">
        <div class="layout-grid">
            <div class="main-panel">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                    ...
                    <div class="summary-card">
                        ...
                        <div>
                            <small class="text-gray-500 font-bold uppercase text-[10px] tracking-wider">IAR Aktif</small>
                ...
                <!-- Segmentation Card -->
                <div class="db-card bg-slate-50 border-slate-200">
                    <h3 class="text-sm font-bold text-slate-700 mb-4 uppercase tracking-widest"><i class="fas fa-filter mr-2"></i> Orari Segmentation</h3>
                    <div id="filter-kabupaten" class="mb-4"></div>
                    <div id="filter-tingkat" class="border-t pt-4 mb-4"></div>
                ...
                <div class="chart-grid">
                    ...
                    <div class="db-card">
                        <h4 class="font-bold text-gray-800 mb-4">Status IAR</h4>
                        <div class="chart-wrapper"><canvas id="chartIar"></canvas></div>
                    </div>
                    <div class="db-card">
                        <h4 class="font-bold text-gray-800 mb-4">Jenjang Tingkat</h4>
            ...
            <!-- Bagian Side Panel sengaja dibiarkan kosong sesuai permintaan layout tengah -->
        </div>
    </div>
    ...
    <script>
        ...
        function updateDashboard() {
            ...
            document.getElementById('stat-total-footer').innerText = filtered.length.toLocaleString();
        ...
        window.onload = () => { updateVisitorStats(); init(); };
    </script>
</body>
</html>