...
<head>
    ...
    <title>Visi Misi - LOKA MONITOR SFR AMBON</title>
</head>
<body>
    <header class="header">
    ...
    <div class="container mx-auto max-w-5xl">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-500 mt-4 font-medium uppercase tracking-wider">Loka Monitor Ambon</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div class="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-blue-50 hover:shadow-2xl transition-all reveal-left">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h3 class="text-2xl font-black text-[#002B49] uppercase tracking-tighter">Visi</h3>
                </div>
                
                <div class="relative">
                    <i class="ri-double-quotes-l text-6xl text-blue-100 absolute -top-6 -left-4"></i>
                    <p class="text-lg md:text-xl font-medium leading-relaxed text-gray-700 italic relative z-10 pl-4 border-l-4 border-blue-600">
            ...
            <div class="bg-[#002B49] rounded-3xl p-8 md:p-12 shadow-xl text-white hover:shadow-2xl transition-all reveal-left" style="transition-delay: 0.2s;">
                <div class="flex items-center gap-4 mb-8 border-b border-white/10 pb-6">
                    <div class="w-14 h-14 bg-blue-500 rounded-2xl flex items-center justify-center text-white shadow-lg">
                        <i class="ri-flag-line text-3xl"></i>
                    </div>
                    <h3 class="text-2xl font-black uppercase tracking-tighter">Misi</h3>
                </div>

                <ul class="space-y-6 text-blue-50">
                    <li class="flex gap-4 group">
                        <span class="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-500 transition-colors">1</span>
                        <p class="text-sm md:text-base leading-relaxed">Melaksanakan pengawasan dan pengendalian penggunaan spektrum frekuensi radio secara efektif.</p>
                    </li>
                    <li class="flex gap-4 group">
                        <span class="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-500 transition-colors">2</span>
                        <p class="text-sm md:text-base leading-relaxed">Meningkatkan kualitas pelayanan publik di bidang spektrum frekuensi radio dan perangkat telekomunikasi.</p>
                    </li>
                    <li class="flex gap-4 group">
                        <span class="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-500 transition-colors">3</span>
                        <p class="text-sm md:text-base leading-relaxed">Mengembangkan kompetensi SDM dan infrastruktur monitoring yang adaptif terhadap perkembangan teknologi.</p>
                    </li>
                </ul>
            </div>
        </div>
